...
(function (doc) {
	...
	Alert = function () {
		function Alert() {_classCallCheck(this, Alert);
			...
			activeAlert = this;
		}_createClass(Alert, [{ key: 'createAlertElements', value: function createAlertElements()
			...
			} }, { key: 'promptAlert', value: function promptAlert(

			hdr, content, btnConfirmText, btnDismissText, fnConfirm, fnDismiss) {
			...
			btnConfirmText, btnDismissText, fnConfirm, fnDismiss) {
				...
				this.btnConfirm.addEventListener('click', this.onConfirm, false);
				this.btnDismiss.addEventListener('click', this.onDismiss, false);
			} }, { key: 'showAlert', value: function showAlert()
			...
			} }, { key: 'dismissAlert', value: function dismissAlert()
...
(function (doc) {
	...
	var config = {
		apiKey: 'AIzaSyCgPr6C2_Y4D-p8grQ_TfT7-hTrRii3VfQ' };var


	Gmap = function () {
		function Gmap(el, loadCallback) {_classCallCheck(this, Gmap);
			...
			this.addScript();
		}_createClass(Gmap, [{ key: 'initMap', value: function initMap()
			...
			} }, { key: 'setDefaultCenter', value: function setDefaultCenter()
			...
			} }, { key: 'setDefaultZoom', value: function setDefaultZoom()
	...
	GmapInitializer = function () {function GmapInitializer() {_classCallCheck(this, GmapInitializer);}_createClass(GmapInitializer, null, [{ key: 'init', value: function init()
			{
				app.$.forEach('.gmap-auto-init', function (el) {
					new Gmap(el);
				});
			} }]);return GmapInitializer;}();
...
(function (doc) {
	...
	LazyContent = function () {
		function LazyContent(el) {_classCallCheck(this, LazyContent);
			this.container = el;
			this.src = el.getAttribute('data-src');
			this.loadContent();
		}_createClass(LazyContent, [{ key: 'loadContent', value: function loadContent()
			...
			{var _this = this;
				...
				then(function (rsp) {
					if (rsp.success) {
						_this.container.insertAdjacentHTML('afterend', rsp.obj.html);
	...
	LazyContentHandler = function () {function LazyContentHandler() {_classCallCheck(this, LazyContentHandler);}_createClass(LazyContentHandler, null, [{ key: 'load', value: function load()
			{
				app.$.forEach('[data-content-lazy]:not(.lazy-loaded)', function (el) {
					new LazyContent(el);
				});
			} }]);return LazyContentHandler;}();
...
(function (doc) {
	...
	LazyImg = function () {
		function LazyImg(el) {_classCallCheck(this, LazyImg);
			this.img = el;
			this.src = el.getAttribute('data-src');
			this.init();
		}_createClass(LazyImg, [{ key: 'init', value: function init()
			...
			{var _this2 = this;
				...
				setTimeout(function (_) {
					...
					_this2.img.classList.add('lazy-loaded');
				}, 10);
			} }]);return LazyImg;}();var


	LazyImgHandler = function () {function LazyImgHandler() {_classCallCheck(this, LazyImgHandler);}_createClass(LazyImgHandler, null, [{ key: 'loadImages', value: function loadImages()
			{
				app.$.forEach('[data-lazy]:not(.lazy-loaded)', function (el) {
					new LazyImg(el);
				});
			} }]);return LazyImgHandler;}();
...
(function (doc) {
	...
	Nav = function () {function Nav() {_classCallCheck(this, Nav);}_createClass(Nav, null, [{ key: 'init', value: function init()
			{
				this.triggers = app.$$('.nav-trigger');

				this.addEventListeners_();
			} }, { key: 'addEventListeners_', value: function addEventListeners_()

			{
				app.$.forEach(this.triggers, function (trigger) {
...
(function (doc) {
	...
	Router = function () {function Router() {_classCallCheck(this, Router);}_createClass(Router, null, [{ key: 'init', value: function init()
			{
				this.mainContainer = app.$('#page-container');
				this.path = window.location.pathname;
				this.addEventListners_();
			} }, { key: 'addEventListners_', value: function addEventListners_()

			{var _this3 = this;
				doc.body.addEventListener('click', function (e) {return _this3.handleClick_(e);});
				window.addEventListener('popstate', function (e) {return _this3.popstateHandler_(e);});
			} }, { key: 'handleClick_', value: function handleClick_(
			...
			} }, { key: 'go_', value: function go_(

			path, updateState) {var _this4 = this;
			...
			} }, { key: 'fadePageOut_', value: function fadePageOut_()

			{var _this5 = this;
				return new Promise(function (resolve, reject) {
					var onTransitionEnd = function onTransitionEnd() {
						_this5.mainContainer.removeEventListener('transitionend', onTransitionEnd);
						resolve();
					};

					_this5.mainContainer.addEventListener('transitionend', onTransitionEnd);
					doc.body.classList.add('page-out');
				});
			} }, { key: 'loadPageContent_', value: function loadPageContent_(
			...
			} }, { key: 'fadePageIn_', value: function fadePageIn_()

			{var _this6 = this;
				return new Promise(function (resolve, reject) {
					var onTransitionEnd = function onTransitionEnd() {
						_this6.mainContainer.removeEventListener('transitionend', onTransitionEnd);
						resolve();
					};

					window.scrollTo(0, 0);
					_this6.mainContainer.addEventListener('transitionend', onTransitionEnd);
			...
			} }, { key: 'popstateHandler_', value: function popstateHandler_()
...
(function (doc) {
	...
	var cssClasses = {
		...
		NAV_IN: 'side-nav-in' };var


	SideNav = function () {
		function SideNav() {_classCallCheck(this, SideNav);
			...
			this.addEventListeners();
		}_createClass(SideNav, [{ key: 'addEventListeners', value: function addEventListeners()
			...
			} }, { key: 'showSideNav', value: function showSideNav(
			...
			e) {
				...
				e.preventDefault();
			} }, { key: 'hideSideNav', value: function hideSideNav(
			...
			} }, { key: 'blockClicks', value: function blockClicks(
...
(function (doc) {
	...
	Toast = function () {
		function Toast() {_classCallCheck(this, Toast);
			if (activeToast) {
			...
			activeToast = this;
		}_createClass(Toast, [{ key: 'createToastElement', value: function createToastElement()
...
(function (doc) {
	...
	Form = function () {
		...
		_createClass(Form, [{ key: 'initFormElements', value: function initFormElements() {
				app.$.forEach(this.inputFields, function (container) {
		...
		}, { key: 'initEditors', value: function initEditors() {
				app.$.forEach(this.fields, function (field) {
			...
			// Helper function to check if required fields have valid data
				...
				app.$.forEach(this.reqFields, function (field) {
					var val = '';
		...
		}, { key: 'setFieldValues', value: function setFieldValues(obj) {
				app.$.forEach(this.fields, function (field) {
			...
			// run checkActiveInputs to reset the labels.
				...
				app.$.forEach(this.fields, function (field) {
					var lbl = field.querySelector('.' + formCssClasses.errorLabel);
					var type = field.type ? field.type.toLowerCase() : '';
					var tag = field.tagName.toLowerCase();
				...
				app.$.forEach('.row-preview', function (row) {
					row.innerHTML = '';
				}, this.container);

				app.$.forEach('.btn-item-upload-delete', function (btn) {
...
(function (doc) {
	...
	var cssClasses = {
		...
		REQUIRED_FIELD: 'req' };var


	Select = function () {
		function Select(select) {_classCallCheck(this, Select);
			...
			this.createMenu();
			this.addEventListeners();
		}_createClass(Select, [{ key: 'addEventListeners', value: function addEventListeners()
			...
			} }, { key: 'focusHanlder', value: function focusHanlder(
			...
			} }, { key: 'changeHandler', value: function changeHandler(

			e) {
				if (this.onChange && typeof this.onChange === 'function') {
					this.onChange();
				}
			} }, { key: 'bodyClickHandler', value: function bodyClickHandler(
			...
			} }, { key: 'checkIfRequired', value: function checkIfRequired()

			{
				var selected = this.menu.querySelector('[selected="true"]');
				var errorLbl = this.container.querySelector('.' + cssClasses.ERROR_LABEL);
				var lbl = void 0;
			...
			} }, { key: 'getTextValue', value: function getTextValue()
	...
	ListItem = function () {
		function ListItem(opt, index, select) {_classCallCheck(this, ListItem);
			...
			return this;
		}_createClass(ListItem, [{ key: 'addEventListeners', value: function addEventListeners()
...
(function (doc) {
	...
	var regExpressions = {
		...
		DATE: /^(0[1-9]|1[0-2])\/(0[1-9]|1\d|2\d|3[01])\/(19|20)\d{2}$/ };var


	TextBox = function () {
		// Provide the input element for this TextBox
		function TextBox(input) {_classCallCheck(this, TextBox);
			// elements
			this.input = input;
		...
		_createClass(TextBox, [{ key: 'addEventListeners', value: function addEventListeners() {
