...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" Runat="Server">
    <div class="banner banner-home">
        <div class="banner-content">
            ...
            <div class="banner-col">
                <h2 class="banner-tagline">Passionate Web Developers that produce the highest quality work using innovative development strategies.</h2>
    ...
    <section class="section">
        <div class="section-content">
            <div class="home-section-block">
                <h3 class="section-hdr">Fast, Creative, User-Friendly Websites</h3>
            ...
            <div class="home-section-block">
                <h3 class="section-hdr">Modern Web Development</h3>
            ...
            <div class="home-section-block">
                <h3 class="section-hdr">Customized Content Management (CMS)</h3>
            ...
            <div class="home-section-block">
                <h3 class="section-hdr">Mobile Friendly, Responsive Web Design</h3>
            ...
            <div class="home-section-block">
                <h3 class="section-hdr">On the Cutting-Edge</h3>
            ...
            <div class="home-section-block">
                <h3 class="section-hdr">Search Engine Optimization (SEO)</h3>
