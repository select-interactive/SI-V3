<%@ Control Language="VB" AutoEventWireup="false" CodeFile="aboutLazy.ascx.vb" Inherits="controls_pages_aboutLazy" %>
<section class="section">
	<div class="section-content">
		<h2 class="section-hdr xl text-center">Awards and Recognition</h2>
		<ul class="awards-list">
			<li>2017 Recipient of the GD USA American Web Design Award for 7 projects - <a href="http://www.stantonllp.com" target="_blank">Stanton LLP</a>, <a href="http://www.banneroak.com" target="_blank">Banner Oak Capital Partners</a>, <a href="http://www.thanksgivingtower.com" target="_blank">Thanksgiving Tower</a>, <a href="http://www.hudsonpeters.com" target="_blank">Hudson Peters Commercial</a>, <a href="http://www.rios-group.com" target="_blank">The Rios Group</a>, <a href="https://www.progressivewell.com/" target="_blank">Progressive Wellness</a>, and for <a href="/">our very own site, Select Interactive version 4</a>!</li>
