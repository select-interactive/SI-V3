...
<div class="paper paper-gray-light copy">
	<div class="content-container">
		...
		<div class="row row-cols-2">
			...
			<div class="col">
				<h3 class="copy-hdr"><i class="material-icons">important_devices</i>Responsive Web Design (RWD)</h3>
		...
		<div class="row row-cols-2">
			<div class="col">
				<h3 class="copy-hdr"><i class="material-icons">timeline</i>Search Engine Optimization (SEO)</h3>
			...
			<div class="col">
				<h3 class="copy-hdr"><i class="material-icons">insert_photo</i>Content Management Systems</h3>
...
<div class="paper paper-pad-med paper-gray-dark">
	<h2 class="copy-hdr copy-hdr-xl text-center">Our Friends</h2>
	<ul class="clients">
