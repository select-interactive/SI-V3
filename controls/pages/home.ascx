...
<section class="section">
    <div class="section-content">
        <div class="home-section-block">
            <h3 class="section-hdr"><i class="material-icons">code</i>Fast, Creative, User-Friendly Websites</h3>
        ...
        <div class="home-section-block">
            <h3 class="section-hdr"><i class="material-icons">cloud</i>Modern Web Development</h3>
        ...
        <div class="home-section-block">
            <h3 class="section-hdr"><i class="material-icons">filter</i>Customized Content Management (CMS)</h3>
        ...
        <div class="home-section-block">
            <h3 class="section-hdr"><i class="material-icons">important_devices</i>Mobile Friendly, Responsive Web Design</h3>
        ...
        <div class="home-section-block">
            <h3 class="section-hdr"><i class="material-icons">whatshot</i>On the Cutting-Edge</h3>
