...
<section class="section">
    <div class="section-content text-center">
        ...
        <div class="home-section-block">
            ...
            <p>Our goal is to help build a better web with every project, and we achieve that by using the latest web technologies and following web standards.</p>
        </div>
        <div class="home-section-block">
        ...
        <div class="home-section-block">
            ...
            <p>We love pushing the boundaries of the web and finding ways to use new technologies to improve our products. Whether that&rsquo;s a faster turnaround time, improved site speed, design strategies, and more, we&rsquo;re always searching for better solutions.</p>
        </div>
        <div class="home-section-block">
